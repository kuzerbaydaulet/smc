...
<div class="container" width='80'>
    ...
    <form action="?act=manager-4-log" method="post" class="form-horizontal col-lg-offset-2"  >
	...
	<?php
	    ...
	    if( isset($_POST['qual-log']) ){
	        
	        if( count($_POST['qual-log'])>0 ){
                ...
                for( $i=0; $i<count($_POST['qual-log']); $i++ ){
                    ...
                    for( $j=0; $j<count($clients);$j++ ){
                        ...
                        if( $_POST['qual-log'][$i]['client_id']==$clients[$j]['id'] ){
                    ...
                    for( $k=0; $k<count($managers); $k++ ){
                        ...
                        if( $_POST['qual-log'][$i]['manager_id']==$managers[$k]['id'] ){
                    ...
                    for( $f=0; $f<count($goods); $f++ ){
                        ...
                        if( $_POST['qual-log'][$i]['goods_id']==$goods[$f]['id'] ){
                            $good = $goods[$f]['name'];
                        }
                    ...
                    echo "<tr>
                            ...
                            <td>".$manager."</td>
                            <td>".$good."</td>
                            <td>".$_POST['qual-log'][$i]['complaints_and_suggestion']."</td>
                            <td>".$_POST['qual-log'][$i]['date']."</td>
                        </tr>";
                }
